...
const TimelineItem = React.forwardRef<HTMLLIElement, TimelineItemProps>(
  (
      ...
      return (
        ...
        >
          <div className="grid grid-cols-[minmax(auto,8rem)_auto_1fr] items-start px-4">
            ...
            <div className="mx-3 flex flex-col items-center justify-start gap-y-2">
              <div className="relative flex h-8 w-8 items-center justify-center rounded-full bg-blue-lagoon/20 ring-8 ring-background">
    ...
    const content = (
      <div
        className="grid grid-cols-[100px_auto_1fr] gap-4 items-start"
        {...(status === "in-progress" ? { "aria-current": "step" } : {})}
      >
        {/* Date */}
        <div className="flex flex-col justify-start pt-1">
          <TimelineTime className="text-right font-lighter text-prussian-blue text-2xl pr-4">
            {date}
          </TimelineTime>
        </div>
...
const TimelineIcon = ({
  ...
  const colorClasses = {
    primary: "bg-blue-lagoon text-primary-foreground",
